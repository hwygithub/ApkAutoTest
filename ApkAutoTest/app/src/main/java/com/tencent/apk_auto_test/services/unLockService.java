...
public class unLockService extends Service {
	...
	@SuppressLint("NewApi")
	public void startForeBackgroud() {
		Log.e(TAG, "unLockService startForeBackgroud");
		NotificationManager nm = null;
		Notification notification = null;
		PendingIntent mPendingIntent = null;
		// Intent intent = new Intent();
		// intent.setAction(RunService.ACTION_STOP);
		// mPendingIntent = PendingIntent.getBroadcast(this, 0, intent, 0);

		Notification.Builder nmb = new Notification.Builder(this);
		nmb.setSmallIcon(R.drawable.icon);
		nmb.setContentText("���������Э�");
		nmb.setContentTitle(getString(R.string.app_name));
		nmb.setDefaults(Notification.DEFAULT_ALL);
		nmb.setContentIntent(mPendingIntent);
		nmb.setAutoCancel(true);
		notification = nmb.getNotification();
